// ARŞİV — artık Muhasebe ana menüsünde YOK (kullanıcı isteğiyle 5 sekmelik yeni yapıya
// geçildi: Giderler/Alışlar, Gelirler/Satışlar, Toptancılar ve Cari Takibi, Ortaklar Cari
// Takip, Reçeteler). Bu dosya silinmedi, ileride lazım olursa referans olarak duruyor.
// Kullanılan yerler: eski Fatura/Makbuz (4 alt tip), eski Toptancılar listesi (basit
// bakiye alanlı), Personel sekmesi, eski Fatura Detaylı Giriş.
import React, { useState, useEffect, useMemo } from 'react';
import { Copy, MessageCircle, Plus, Trash2, Lock, Delete, Check, X, Search, Pencil } from 'lucide-react';

const PERSONEL_PIN = '1234';

const TOPTANCI_KATEGORILERI_ESKI = [
